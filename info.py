...
ADMINS = [
    ...
    for admin in environ.get("ADMINS", "5974804314,7087329103").split()
]
...
LOG_CHANNEL = int(environ.get("LOG_CHANNEL", "-1003823651553"))
...
# Other Channel's
SUPPORT_GROUP = int(environ.get("SUPPORT_GROUP", "-1003543883078"))
DELETE_CHANNELS = int(environ.get("DELETE_CHANNELS", "0"))
request_channel = environ.get("REQUEST_CHANNEL", "-1003543883078")
REQUEST_CHANNEL = (
    int(request_channel)
    if request_channel and id_pattern.search(request_channel)
    else None
)
MOVIE_UPDATE_CHANNEL = int(environ.get("MOVIE_UPDATE_CHANNEL", "-1003543883078"))
